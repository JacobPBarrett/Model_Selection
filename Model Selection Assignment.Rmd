...
**Can you do this? Can you choose to model average over a select number of models?** 
...
<span style="color:black;font-size:30px">2.3 Model formation and multicolinearity check</span>
...
<span style="color:black;font-size:30px">2.6 Visualization of the most important parameters</span>
